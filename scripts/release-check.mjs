...
const buildVersion = process.env.ASIRI_VERSION || packageVersion;
...
if (buildVersion !== packageVersion) failures.push(`build version ${buildVersion} must match package version ${packageVersion}`);
